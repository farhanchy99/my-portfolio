          ...
          <div className="service-items">
            <div className="service-col">
              <div className="service-item content-box">
                ...
                <div className="text">+8801796549213</div>
              </div>
            </div>
            <div className="service-col">
              <div className="service-item content-box">
            ...
            <div className="service-col">
              <div className="service-item content-box">
                ...
                <div className="text">Sylhet, Bangladesh</div>
              </div>
            </div>
            <div className="service-col">
              <div className="service-item content-box">
      ...
      <div className="section contacts" id="section-contacts">
        <div className="content">
          ...
          <div className="contact_form content-box">
            <form id="cform" method="post" action="https://formspree.io/f/mknazvwe">
